...
public class QuoteSide implements Tradable {
	...
	public QuoteSide(String userName, String productSymbol, Price orderPrice, int originalVolume, String side) throws InvalidVolumeOperation{
		user = userName;
		...
		bookSide = side;
		id = user + product + System.nanoTime();
		}
	}
	...
	*/
	...
	public String toString(){
		return price + " x " + remainingOrderVolume + " (Original Vol: " + originalOrderVolume + ", CXL'd Vol: " +
	           cancelledOrderVolume + ") [" + id + "]"; 
	}
