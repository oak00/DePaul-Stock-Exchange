...
public class Phase2Main {
    ...
    private static void testMessagePublisher() {
        ...
        try {
            ...
            CancelMessage cm = new CancelMessage("REX", "SBUX", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            CancelMessage cm2 = new CancelMessage("REX", "IBM", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            CancelMessage cm3 = new CancelMessage("ANN", "SBUX", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            CancelMessage cm4 = new CancelMessage("ANN", "IBM", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            FillMessage fm = new FillMessage("REX", "SBUX", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            FillMessage fm2 = new FillMessage("REX", "IBM", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            FillMessage fm3 = new FillMessage("ANN", "SBUX", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            FillMessage fm4 = new FillMessage("ANN", "IBM", PriceFactory.makeLimitPrice("52.00"), 140, "Cancelled By User", "BUY", "ABC123XYZ");
            ...
            MessagePublisher.getInstance().publishMarketMessage(new MarketMessage("PREOPEN"));
            System.out.println(); 
            
            MessagePublisher.getInstance().subscribe(u2, "SBUX");
            System.out.println("28) Send a MarketMessage. REX and ANN are MessagePublisher subscribers so REX & Ann get the message.");
            MessagePublisher.getInstance().publishMarketMessage(new MarketMessage("OPEN"));
            System.out.println(); 
            ...
            MessagePublisher.getInstance().publishMarketMessage(new MarketMessage("CLOSED"));
    ...
    static class UserImpl implements User {
		...
		public String submitOrder(String product, Price price, int volume,
				String side) throws InvalidVolumeOperation,
		...
		public void submitOrderCancel(String product, String side,
				...
				NoSuchProductException, InvalidVolumeOperation,
				UserNotConnectedException, InvalidConnectionIdException {
			// TODO Auto-generated method stub
		...
		public void subscribeCurrentMarket(String product)
				throws AlreadySubscribedException, UserNotConnectedException,
				InvalidConnectionIdException {
			// TODO Auto-generated method stub
		...
		public String[][] getBookDepth(String product)
				throws NoSuchProductException, UserNotConnectedException,
				InvalidConnectionIdException {
			// TODO Auto-generated method stub
			return null;
		}
